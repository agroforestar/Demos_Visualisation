...
public class TractorsBoucliersLight : MonoBehaviour
{
    ...
    public void GetAnglesFromParcelle()
    {
        ...
        print("herererc");
        _newParcelle = ARManagerBoucliersLight._newParcelle;
    ...
    public void AddTractors()
    {
        ...
        else
        {
            ...
            GameObject.Find("AddTractor").GetComponent<Image>().sprite = Resources.Load<Sprite>("Plus-green");
            ...
            //
            newObject = CollisionTractorBoucliersLight.newObject;
            //
            if (newObject != null){
                print("Destroy");
                Destroy(newObject);
    ...
    public void PlayAndStop()
{
    ...
    {
        float speed = TractorInitialisation ? 0.25f : 1.75f;
