...
public class ARManagerBoucliersLight : MonoBehaviour
{
    ...
    IEnumerator InstantiateVisualisation()
    {
        ...
        transform.GetComponent<TractorsBoucliersLight>().GetAnglesFromParcelle();

        _panel.SetActive(true);
        print("eeeeeeeeeeeeeeeeeeeeeeeeh oooooooooooh");
